...
public class ProjectECompat {
    private static final ResourceLocation TRANSMUTATION_TABLE =
            ResourceLocation.fromNamespaceAndPath("projecte", "transmutation_table");
    private static final ResourceLocation TRANSMUTATION_TABLET =
            ResourceLocation.fromNamespaceAndPath("projecte", "transmutation_tablet");
