...
public final class Config {
    ...
    private static final ForgeConfigSpec.EnumValue<LootConfig.ListMode> SKIP_LIST_MODE;
    ...
    private static final ForgeConfigSpec.EnumValue<LootConfig.RarityMode> RARITY_MODE;
